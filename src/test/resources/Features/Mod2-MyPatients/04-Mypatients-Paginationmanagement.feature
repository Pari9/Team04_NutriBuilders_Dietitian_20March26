...
Rule: Pagination with maximum records per page
  System should validating page size

  Background:
    Given Maximum 5 patient records exist per page

  Scenario: Each page displays only 5 records
    Then User should see only 5 records per page

  Scenario: Newly added 6th record moves to next page
    When User adds a 6th patient record
    Then Newly added record should appear on the next page